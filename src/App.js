...
let subbota = require('./sub.json');
let libraries = require('./timetable_updated.json');
...
function App() {
  ...
  let daysJson = libraries.groups[group].days;
  ...
  try { daySix = libraries.groups[group].days[5].subjects  } catch (error) {console.log('error')}
